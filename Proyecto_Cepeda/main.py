...
class MillonarioApp:
    ...
    def iniciar_juego(self):
        ...
        btn_facil = tk.Button(self.juego_ventana, text="Fácil", font=("Roboto", 16), bg='#87CEEB', command=lambda: self.dificultad_juego("facil"))
        btn_facil.config(width=15)
        btn_facil.pack(pady=10)

        btn_medio = tk.Button(self.juego_ventana, text="Medio", font=("Roboto", 16), bg='#87CEEB', command=lambda: self.dificultad_juego("medio"))
        btn_medio.config(width=15)
        btn_medio.pack(pady=10)

        btn_dificil = tk.Button(self.juego_ventana, text="Difícil", font=("Roboto", 16), bg='#87CEEB', command=lambda: self.dificultad_juego("dificil"))
        btn_dificil.config(width=15)
        btn_dificil.pack(pady=10)

    def dificultad_juego(self, dificultad):
    ...
    def imprimir_base_de_datos(self):
        ...
        try:
            ...
            ventana_bd.protocol("WM_DELETE_WINDOW", self.base_de_datos.cerrar_conexion())
            ventana_bd.mainloop()
